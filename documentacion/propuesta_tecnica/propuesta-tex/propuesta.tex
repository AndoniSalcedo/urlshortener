...
\begin{table}[hbtp]
    ...
    Cumplimiento &
     \labelitemi \quad El usuario recibirá por correo el enlace recortado que ha sido creado. &&

     \labelitemi \quad Al usuario se le ofrecerá un QR para poder compartir de una manera más sencilla la URL . \\
...
\begin{table}[hbtp]
    ...
    10: &&
        ...
        \quad \labelitemi \quad La aplicación permitirá al usuario eliminar sus URL creadas. &&
    15: &&
        \quad \labelitemi \quad Cumplir nivel 10. && 
        \quad \labelitemi \quad La aplicación almacenará el número de clicks realizados sobre cada URL del usuario. \\
